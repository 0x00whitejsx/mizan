...
<div className='md:w-2/6 bg-green-700 pattern  h-[100vh] '>

</div>

      <div className='md:w-4/6 h-[100vh] bg-gray-200 flex flex-col justify-center items-center md:p-10'>
      <Link to="/" className='mb-10 text-4xl align-middle'><span className='text-green-400'>m</span>izan.com</Link>
        <form className='bg-white shadow-sm p-10 mt-50 md:w-1/2 w-full'>
          ...
          <p className='text-gray-400 mt-10'>Not yet register? <Link to="/login" className='text-green-400'>Login here</Link></p>
        </form>
      </div>
